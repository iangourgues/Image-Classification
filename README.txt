...
Simply run each cell in JupyterLab to allow the AI get a batch of images from the iterator, preprocess the data, train the data, and
plot the performance. When you arrive at the testing segment, there is a line of code which reads "img = cv2.imread('Man.jpg')" that
